...
// Scan indicates an expected call of TTL.
func (mr *MockRedisClientInterfaceMockRecorder) Scan(ctx context.Context, cursor uint64, match string, count int64) *gomock.Call {
	mr.mock.ctrl.T.Helper()
